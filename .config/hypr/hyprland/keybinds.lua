...
hl.bind(vars.kbUtilitiesPanel, hl.dsp.global("caelestia:session"))
...
hl.bind(vars.kbWallpaperPicker, hl.dsp.global("caelestia:wallpaper"))
hl.bind(vars.kbWindowSwitcher, hl.dsp.global("caelestia:windowSwitcher"))
hl.bind(vars.kbKeybindsList, hl.dsp.global("caelestia:keybinds"))
